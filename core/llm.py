...
from core.prompts import QUERY_SYSTEM_PROMPT, FINAL_SYSTEM_PROMPT
...
def build_final_prompt(
    ...
    prompt += "위의 가맹점 분석 데이터와 검색된 마케팅 전략 문서를 기반으로 컨설팅 리포트를 작성하라."
    return prompt
...
def generate_rag_report(
    ...
    Args:
        ...
        query_stream_callback  : 1단계 LLM 스트리밍 콜백
        report_stream_callback : 2단계 LLM 스트리밍 콜백
